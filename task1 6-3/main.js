...
// 9- Use the string method "toLowerCase()" to convert the string "message" to lowercase.
 /******* Start Your Code *********/
  var user = 'yoUSEF';
  var toLowerCase = user.toLowerCase();
...
// 10- Use the string method "indexOf()" to find the position of the word "JavaScript" in the string "I love learning JavaScript".
 /******* Start Your Code *********/
  var paragraph = "I love learning JavaScript fdsf fdsf";
  var search = "JavaScript";
  var indexOf = paragraph.indexOf(search);
  console.log(indexOf);
